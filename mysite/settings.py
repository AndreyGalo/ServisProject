...
SECRET_KEY = 'django-insecure-g4l)jk8%95kbnn-r4di$4q0-5%cy$v-0+a@bcqt!v85q&31zo='
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'servis/media')
...
DEFAULT_FORM_EMAIL = "adminservisptu26@inbox.lt"
